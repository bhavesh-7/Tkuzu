...
import com.example.tkuzudriver.activities.DriverHomeActivity
...
class SplashScreenActivity : AppCompatActivity() {
    ...
    private fun showRegisterUserLayout() {
        val builder = AlertDialog.Builder(this, R.style.Base_Theme_TkuzuDriver)
    ...
    private fun showLoginLayout() {
        ...
        val signInIntent = AuthUI.getInstance()
            ...
            .setTheme(R.style.Base_Theme_TkuzuDriver)
